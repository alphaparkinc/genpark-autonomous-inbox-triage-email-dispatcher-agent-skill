# genpark-autonomous-inbox-triage-email-dispatcher-agent-skill
...
> **GenPark AI Agent Skill** -- Autonomous inbox triage email dispatcher & smart responder (AI Email Agent)
